...
module.exports = "/ponpons.44f5a57e.jpg";
},{}],"../../js/main.js":[function(require,module,exports) {
"use strict";

var _ponpons = _interopRequireDefault(require("../img/imagesForProductsMain/ponpons.jpg"));

var _ponponetjes = _interopRequireDefault(require("../src/html/ponponetjes.html"));
...
// arrays
var links = [_ponponetjes.default // "/html/headbands.html",
// "/html/animals.html",
// "/html/letters.html",
// "/html/zodiac.html",
];
var titles = ["ponponetjes", "headbands", "animals", "letters", "zodiac signs"];
var images = _ponpons.default;
console.log(images); // const texts = [
...
var sidebarHeader = document.querySelector(".section-header"); // end of variables
// addEventListers

window.addEventListener("DOMContentLoaded", function () {
  return sidebartoggle();
}, BtnDisplay(), Products()); // end of addEventListeners
// functions
  ...
  btns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      if (e.currentTarget.classList.contains("fa-bars")) {
        ...
        sidebarHeader.style.display = "hidden";
      } else if (e.currentTarget.classList.contains("fa-times")) {
        sidebar.classList.remove("show-sidebar");
        sidebarHeader.style.display = "visible";
      }
    });
  });
}
...
},{"../img/imagesForProductsMain/ponpons.jpg":"../../img/imagesForProductsMain/ponpons.jpg","../src/html/ponponetjes.html":"ponponetjes.html"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("../../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["ponponetjes.html","ponponetjes.html"]]).then(function(){require("../../js/main.js");});
