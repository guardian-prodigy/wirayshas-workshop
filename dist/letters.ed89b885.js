...
"use strict";var e=n(require("../../../img/letters/A.jpg")),r=n(require("../../../img/letters/B.jpeg")),i=n(require("../../../img/letters/C.jpeg")),t=n(require("../../../img/letters/D.jpeg"));function n(e){return e&&e.__esModule?e:{default:e}}var a=document.querySelector(".letters-A-D"),s=[e.default,r.default,i.default,t.default],c=["50.00"],l=["https://instagram.com/wiraysha_workshop?igshid=4byv5ud4kl4f"],p=[{img:s[0],price:c[0],href:l[0]},{img:s[1],price:c[0],href:l[0]},{img:s[2],price:c[0],href:l[0]},{img:s[3],price:c[0],href:l[0]}];function u(){var e=p.map(function(e){return'<li class="static-letters">\n    <div class="img-container-letter">\n      <img src='.concat(e.img,' />\n    </div>\n    <div class="price-info">\n      <p style="border: none" class="price-letters header-price">\n        <span>').concat(e.price,'</span>\n      </p>\n      <a\n        href="').concat(e.href,'"\n        ><i class="fab fa-instagram"></i\n      ></a>\n    </div>\n  </li>')}).join("");a.innerHTML=e}u();
...
//# sourceMappingURL=/letters.ed89b885.js.map